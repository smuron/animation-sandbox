...
function newTile() {
  ...
  $("#parent").append('<div class="box rotateIn x'+tile.x+' y'+tile.y+'" style="background-image: url(\''+tile.image+'\'); background-color: '+tile.color+'; top: '+tile.y+'px; left: '+tile.x+'px"></div>');
